...
UPDATE sidebar_items SET divider_before = 'Arquivo Digital'         WHERE id = 'caab53b5-dccb-4683-9afc-b4c44c7b698d';
...
-- 3. Reparentar eSocial/RAIS/DCTFWeb para SPED & Entregas
...
-- [removido - item ja existe na seed] -- 4. Novo item: Parâmetros Globais
-- [removido - item ja existe na seed] INSERT INTO sidebar_items (id, path, label, module, icon, parent_id, divider_before, ordem, disabled, action_type, resource)
-- [removido - item ja existe na seed] VALUES (gen_random_uuid(), '/app/sistema/parametros', 'Parâmetros Globais', 'admin', 'FiDatabase', NULL, NULL, 13, false, 'link', 'parametros-globais');
...
-- 6. Reordenar raiz
UPDATE sidebar_items SET ordem = 1  WHERE id = 'c3753cdd-43f0-49a8-9609-9b0d853e4843';
UPDATE sidebar_items SET ordem = 2  WHERE id = 'caab53b5-dccb-4683-9afc-b4c44c7b698d';
UPDATE sidebar_items SET ordem = 3  WHERE id = '9ce167d9-e911-41d5-8fbe-80e92079a7a1';
UPDATE sidebar_items SET ordem = 4  WHERE id = '322e684b-23ca-40a3-8340-913b2f15a241';
UPDATE sidebar_items SET ordem = 5  WHERE id = '1516d341-c9f5-47a1-8a2e-ed2202a88bc8';
UPDATE sidebar_items SET ordem = 6  WHERE id = 'f22fcbfe-b232-4538-a7de-b9f23dba0389';
UPDATE sidebar_items SET ordem = 7  WHERE id = '243f0ae5-cad2-4655-9b3b-060d3ba1aff8';
UPDATE sidebar_items SET ordem = 8  WHERE id = '14a2d0bd-ba3c-4611-ae4e-f43078f7a0c9';
UPDATE sidebar_items SET ordem = 9  WHERE id = '494bef20-936a-4cf9-8114-bc079d7c012f';
UPDATE sidebar_items SET ordem = 10 WHERE id = 'cb68278d-ecd9-4e1f-93e9-4dcc01332aae';
UPDATE sidebar_items SET ordem = 11 WHERE id = '0c34db2d-d882-496b-9b6d-3b6b328472c6';
UPDATE sidebar_items SET ordem = 12 WHERE id = '88a1af2e-feef-41d1-902a-eded1cb75d55';
UPDATE sidebar_items SET ordem = 14 WHERE id = '08975054-9faf-40cf-9e40-7d34121caa0b';
