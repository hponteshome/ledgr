...
const HEADER_EXAMPLE = 'CODIGO|GRUPO|DESCRICAO|DATA_AQUISICAO|VALOR_AQUISICAO|LAND_PCT|MATRICULA|MUNICIPIO|UF|CONTA_ATIVO|CONTA_DEPREC|CONTA_ACUM|CARTORIO|AREA_CONSTRUIDA|AREA_TOTAL|VALOR_VENAL_ITBI|FRACAO_IDEAL|INSCRICAO_IPTU';
